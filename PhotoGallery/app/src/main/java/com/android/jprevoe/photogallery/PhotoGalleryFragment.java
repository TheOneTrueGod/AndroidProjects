...
public class PhotoGalleryFragment extends Fragment {
        ...
        mPhotoRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (layoutManager.findFirstVisibleItemPosition() + layoutManager.getChildCount() >=
                        layoutManager.getItemCount() - layoutManager.getSpanCount()) {
                    Log.e("tag", "At the end.  Time to load more!");
                }
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder> {
        ...
        @Override
        public PhotoHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        ...
        public void onBindViewHolder(PhotoHolder photoHolder, int position) {
            ...
            Drawable placeholder = getResources().getDrawable(R.drawable.help);
