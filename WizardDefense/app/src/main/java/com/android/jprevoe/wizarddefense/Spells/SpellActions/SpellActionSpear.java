 ...
 */
public class SpellActionSpear extends PlayerAction {
    public static final int ANIMATION_TIME = 100;
    public static final int PROJECTILE_TIME = 300;

    public SpellActionSpear(SpellDefiner.SpellDef spellDef) {
        super(spellDef);
        mTargettableSquares = new SquareTargetable(0, -2, 1, 2);
    }
